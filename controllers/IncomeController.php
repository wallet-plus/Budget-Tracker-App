...
class IncomeController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            ...
            if ($model->load($this->request->post()) && $model->save()) {
                Yii::$app->session->setFlash('success', "Income added successfully.");
                $this->redirect(['index']);
            }
        } else {
    ...
    public function actionUpdate($id_expense)
    {
        ...
        $oldImage = $model->image; // save the old image name for later use
            ...
            if ($model->load(Yii::$app->request->post())) {
                ...
                if ($model->save()) {
                    Yii::$app->session->setFlash('success', "Income updated successfully."); 
                    $this->redirect(['index']);
                }
            }
    ...
    public function actionDelete($id_expense)
    {
        ...
        Yii::$app->session->setFlash('success', "Income deleted successfully."); 
