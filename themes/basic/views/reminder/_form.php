...
<form class="form-sample">
        ...
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <?php echo Html::error($model, 'name', ['class' => 'mat-form-field-infix']); ?>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <?php echo Html::error($model, 'date', ['class' => 'help-block']); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <?= Html::a('Cancel', ['/reminder/index'], ['class' => 'btn btn-light']) ?>
</form>
